...
public enum ResponseStatusCode {
  ...
  SUCCESS(HttpStatus.OK, "msg.success"),
  SUCCESS_CANCEL_VTP_SERVICE(HttpStatus.OK, "msg.success_cancel_vtp_service"),
  ...
  INTERNAL_GENERAL_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR,
      "error.msg.internal_general_server_error"),
