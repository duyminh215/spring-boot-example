...
public enum ErrorMessage {
    ...
    // http code : 412 : precodition fail, 403 : forbidden, 500 - Internal Server Exception, HttpStatus.INTERNAL_SERVER_ERROR - Custom error code
    /** COMMON ******/
    ...
    USER_INFO_CAN_NOT_CHANGE_WITH_IDENTITY_USER(1015, "user_info_can_not_change_with_identity_user", HttpStatus.BAD_REQUEST),
    
    USER_LOCKED_BECAUSE_OF_WRONG_PASS_MANY_TIMES(1006, "user_locked_because_of_wrong_pass_many_times", HttpStatus.INTERNAL_SERVER_ERROR),
    ...
    IDENTITY_REQUEST_APPROINTMENT_TIME_INVALID(1114, "identity_request_approintment_time_invalid", HttpStatus.BAD_REQUEST),
    ...
    EXCEEDED_LIMIT_AMOUNT_PER_TRANSACTION(4302, "exceeded_limit_amount_per_transaction", HttpStatus.PRECONDITION_FAILED),
